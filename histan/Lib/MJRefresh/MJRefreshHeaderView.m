...
#define kRefreshing @"正在刷新，请稍后..."

#define kPullToRefresh_EN @"Slip up to refresh"
#define kReleaseToRefresh_EN @"Release to refresh"
#define kRefreshing_EN @"Loading,Please wait..."
...
- (void)updateTimeLabel
{
    ...
    NSString *time = [formatter stringFromDate:_lastUpdateTime];
       ...
       showTimes=[NSString stringWithFormat:@"最后更新：%@", time];
    
    // 3.显示日期
    _lastUpdateTimeLabel.text =showTimes ;
