...
-(IBAction)operateTask:(id)sender
{
    ...
    FileModel *downFile;
    if (_IsIOS7_) {
        downFile=((DownloadCell *)btnOperate.superview.superview.superview.superview).fileInfo;
    }else{
        downFile=((DownloadCell *)[[[btnOperate superview] superview]superview]).fileInfo;
    }
    ...
    if (_IsIOS7_) {
       tableView=(UITableView *)btnOperate.superview.superview.superview.superview.superview.superview;
    }else{
        tableView=(UITableView *)[[[[btnOperate superview] superview] superview] superview];
    }
